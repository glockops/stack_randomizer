...
<div class="ccm-pane-options">
	<div class="ccm-block-type-search-wrapper ccm-pane-options-permanent-search ">
		...
		<i class="icon-search"></i><?php  echo $form->text('ccmStackSearch', array('tabindex' => 1, 'autocomplete' => 'off', 'style' => 'margin-left: 8px; width: 168px; color: rgb(0,0,0)','class'=>'ccm-input-text'))?>		
		</form>
