...
class FormStackSelectorHelper {
	...
	protected $package  = 'stack_randomizer';
	 ...
	 */
	 ...
	 public function select_stack($fieldName, $stID = false) {
		...
		$html .= '<a class="ccm-select-stack" dialog-sender="' . $fieldName . '" dialog-width="600px" dialog-height="70%" dialog-append-buttons="true" dialog-modal="false" dialog-title="' . t('Choose Stack') . '" href="' . $tools . '">' . t('Select Stack') . '</a>';
	 ...
	 */ 
	 public function select_multi_stack($fieldName, $stIDs) {
		...
		$html .= $ih->button(t('Add Stack'),$tools,'left','ccm-select-stacks',array('dialog-sender'=>$fieldName,'dialog-width'=>'600px','dialog-height'=>'70%','dialog-append-buttons'=>'true','dialog-modal'=>'false','dialog-title'=>t('Choose Stack')));
